...
インストール方法は [プロジェクトに logaling-commmand を導入する](#install) 場合と同じです。
...
用語の検索方法は [プロジェクトに logaling-commmand を導入する](#lookup) 場合と同じです。
...
用語の登録方法は [プロジェクトに logaling-commmand を導入する](#add) 場合と同じです。
...
登録されている用語を編集する方法は [プロジェクトに logaling-commmand を導入する](#update) 場合と同じです。
...
用語を削除する方法は [プロジェクトに logaling-commmand を導入する](#delete) 場合と同じです。
